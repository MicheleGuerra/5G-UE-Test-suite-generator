...
network_daylight_saving_time_values = [
    "OGS_NAS_NO_ADJUSTMENT_FOR_DAYLIGHT_SAVING_TIME",
    "OGS_NAS_PLUS_1_HOUR_ADJUSTMENT_FOR_DAYLIGHT_SAVING_TIME",
    "OGS_NAS_PLUS_2_HOURS_ADJUSTMENT_FOR_DAYLIGHT_SAVING_TIME"
]

sms_indication_type_values = [
    "OGS_NAS_SERVICE_TYPE_SIGNALLING",
    "OGS_NAS_SERVICE_TYPE_DATA",
    "OGS_NAS_SERVICE_TYPE_MOBILE_TERMINATED_SERVICES",
    "OGS_NAS_SERVICE_TYPE_EMERGENCY_SERVICES",
    "OGS_NAS_SERVICE_TYPE_EMERGENCY_SERVICES_FALLBACK",
    "OGS_NAS_SERVICE_TYPE_HIGH_PRIORITY_ACCESS",
    "OGS_NAS_SERVICE_TYPE_ELEVATED_SIGNALLING"
]
...
def generate_test_case(params_to_include, test_id):
    param_values = {
        "network_daylight_saving_time": network_daylight_saving_time_values,
        "sms_indication_type": sms_indication_type_values,
    ...
    directory_name = "generate_configuration_update_command_tests"
    ...
    if args.enable_special_option:
        ...
        param_dict["configuration_update_command_security"] = "disabled"

    if args.second_function in functions_for_third_row:
        output_data = [
            {"ue_ul_handle": "null", "dl_reply": "null", "command_mode": "null", "dl_params": "null"},
            {"ue_ul_handle": "null", "dl_reply": "null", "command_mode": "null", "dl_params": "null"},
            {"ue_ul_handle": args.second_function, "dl_reply": "configuration_update_command", "command_mode": "send", "dl_params": param_dict}
        ]
    elif not param_dict:
        output_data = [
            {"ue_ul_handle": "null", "dl_reply": "null", "command_mode": "null", "dl_params": "null"},
